...
export const metadata: Metadata = {
  ...
  description:
    'IZMVH Design Studio builds exceptional digital experiences — websites, e-commerce solutions, and ongoing support that help businesses grow online.',
    ...
    <html lang="en">
      ...
      <body className="noise">
        ...
        <Footer />
          ...
          href="https://api.whatsapp.com/send/?phone=27634811469&text=Hi+IZMVH+Design+Studio%2C+I+would+like+to+get+a+quote+for+a+website.&type=phone_number&app_absent=0"
          target="_blank"
