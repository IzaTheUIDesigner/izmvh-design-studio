          ...
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              <motion.div key="step1" variants={slideVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                <h2 className="font-grotesk font-bold text-heading text-xl mb-6">About your business</h2>
                <div className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Business Name *</label>
                    ...
                    <div>
                      <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Industry</label>
                  ...
                  <div>
                    <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Existing Website (if any)</label>
                  ...
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Your Name *</label>
                    ...
                    <div>
                      <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Email *</label>
                  ...
                  <div>
                    <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Phone</label>
            ...
            {step === 2 && (
              <motion.div key="step2" variants={slideVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                <h2 className="font-grotesk font-bold text-heading text-xl mb-6">What are you looking to build?</h2>
                ...
                <div className="mt-5">
                  <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Briefly describe your project</label>
            ...
            {step === 3 && (
              <motion.div key="step3" variants={slideVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                <h2 className="font-grotesk font-bold text-heading text-xl mb-6">Website requirements</h2>
                <div className="space-y-6">
                  <div>
                    <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Approx. number of pages</label>
                  ...
                  <div>
                    <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-3">Features needed (select all that apply)</label>
                  ...
                  <div>
                    <label className="block text-xs font-grotesk font-semibold text-muted uppercase tracking-wider mb-2">Do you have existing branding?</label>
                    <div className="flex gap-3">
            ...
            {step === 5 && (
              <motion.div key="step5" variants={slideVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                <h2 className="font-grotesk font-bold text-heading text-xl mb-2">When do you need it?</h2>
                <p className="text-muted text-sm mb-6">Be realistic — great work takes time.</p>
            ...
            {step === 6 && (
              <motion.div key="step6" variants={slideVariants} initial="initial" animate="animate" exit="exit" transition={{ duration: 0.3 }}>
                <h2 className="font-grotesk font-bold text-heading text-xl mb-6">Review your brief</h2>
